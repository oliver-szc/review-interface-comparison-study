...
export default function MobileScreeningOutPage() {
  return (
    <main className="min-h-full bg-slate-50 flex flex-col items-center justify-center p-4">
      <div className="w-full max-w-3xl bg-white p-8 md:p-10 rounded-xl shadow-sm border border-red-200 text-center">
        ...
        <h1 className="text-xl font-bold text-slate-900 mb-4">Thank you for your interest in this study.</h1>
