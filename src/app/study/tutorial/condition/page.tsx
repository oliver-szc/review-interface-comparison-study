            ...
            {visibleStep === 1 && (
              <div>
                ...
                <ul className="list-disc pl-6 space-y-2 text-slate-700 mb-4">
                  <li>Sometimes you will just work with the standard <strong>Review Section</strong>.</li>
                  <li>Sometimes you will be provided with an <strong>AI Chatbot</strong>, which works like a standard conversational AI tool (you can ask specific questions about the reviews).</li>
